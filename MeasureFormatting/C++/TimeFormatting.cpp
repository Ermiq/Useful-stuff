...
void GetTimeFromSeconds(float secondsTotal, int& s, int& m, int& h, int& d, int& y);

int main(int argc, char *argv[])
{
	int s, m, h, d, y;
	float secondsTotal = 3657910;
	GetTimeFromSeconds(secondsTotal, s, m, h, d, y);
	cout << "s: " << s << ", m: " << m << ", h: " << h << ", d: " << d << ", y:" << y << endl;
}
